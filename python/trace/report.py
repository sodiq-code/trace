"""Monthly Compliance Report PDF export (report Sec 29.4, Should Work).
...
Generates a structured PDF per the report's spec:
    ...
    Page 3: legal disclaimer (report Sec 26.4)

Uses ReportLab (Python) per the report. No LLM in the core path — the optional
Compliance Summary paragraph (report Sec 24.3) is omitted by default and can
...
# Report design system (matches the dashboard — report Sec 29.5)
