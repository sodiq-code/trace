"""SQLite persistence for Trace ( / ).

Schema mirrors the four core entities from :
  creators, assets, manifests, verifications.

SQLite is chosen for the MVP : zero-config, single-file,
...
class Database:
  ...
  def __init__(self, db_path: str | Path | None = None) -> None:
    ...
    # check_same_thread=False so FastAPI can share the handle.
