...
```
┌──────────────────┐    direct upload     ┌─────────────────────────────┐
│  Vercel          │ ───────────────────► │  Railway (Python backend)    │
│  Next.js         │   (no body limit)    │  FastAPI + c2pa-python       │
│  dashboard       │ ◄─────────────────── │  ES256 C2PA stamping         │
│  trace-provenance│     JSON response    │  SQLite persistence          │
│  .vercel.app     │                      │  tranquil-bravery-production │
└──────────────────┘                      │  .up.railway.app            │
                                          └─────────────────────────────┘
```
